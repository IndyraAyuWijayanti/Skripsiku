...
class Prediksi extends CI_Controller {
	...
	public function index()
	{
		...
		$data = array('title'     => 'Data Prediksi Obat',
	                  ...
	                  'kategori'  => $this->prediksi_model->kategori_obat()
		  );
    ...
    //     }
		...
		$data = array('title'     => 'Data Prediksi Obat',
					  ...
					  'jenis_item' => $obat,
					  'kategori'  => $this->prediksi_model->kategori_obat(),
					  'jenis_item'  => $this->prediksi_model->jenis_item(),
					  'nama_obat'  => $this->prediksi_model->nama_obat()
	...
	public function getKategori(){
		$queryData = $this->db->query("SELECT * FROM tbl_kategori")->result_array();
		echo json_encode($queryData);
	}
	public function getJenis(){
		$id = $this->input->post('id_jenisitem');
		$data = $this->db->get_where('tbl_jenisitem', ['id_jenisitem' => $id])->result_array();
		echo json_encode($data);
	}

	public function getNamaobat()
	{
		$id_jenisitem = $this->input->post('id_jenisitem');
		$data = $this->db->get_where('tbl_namaobat', ['id_jenisitem' => $id_jenisitem])->result_array();
		echo json_encode($data);
	}
}